...
SS_I18N.en = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Heat shield', t: 'Heat shield', d: 'About 18,000 hexagonal ceramic tiles cover the belly of the ship, the side that faces into the airflow during reentry. They are pinned to the steel skin and protect it from reentry heat of up to about 1,400 °C. The hexagonal pattern stops hot plasma from flowing straight through the gaps.', s: [['Tiles', '~18,000'], ['Shape', 'Hexagonal'], ['Peak', '{tilePeak}']] },
...
SS_I18N.he = {
  ...
  parts: {
    ...
    's-tiles': { n: 'מגן החום', t: 'מגן החום', d: 'כ-18,000 אריחים קרמיים משושים מכסים את צד הבטן של סטארשיפ, הצד שפונה קדימה ונחשף לאוויר הלוהט בזמן החזרה לאטמוספרה. האריחים מוצמדים בפינים לדופן הפלדה ומגנים עליה מחום של עד כ-1,400 °C. הצורה המשושה מונעת מהפלזמה החמה לחדור ישר דרך המרווחים שבין האריחים.', s: [['אריחים', '~18,000'], ['צורה', 'משושה'], ['טמפ׳ שיא', '{tilePeak}']] },
...
SS_I18N.fr = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Bouclier thermique', t: 'Bouclier thermique', d: 'Environ 18 000 tuiles céramiques hexagonales couvrent le ventre de Ship, la face exposée au flux d\'air pendant la rentrée. Fixées sur des goujons de la coque en acier, elles la protègent de la chaleur de rentrée, jusqu\'à environ 1 400 °C. Le motif hexagonal empêche le plasma chaud de s\'engouffrer en ligne droite dans les joints.', s: [['Tuiles', '~18 000'], ['Forme', 'Hexagonale'], ['Pic', '{tilePeak}']] },
...
SS_I18N.pt = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Escudo térmico', t: 'Escudo térmico', d: 'Cerca de 18.000 placas cerâmicas hexagonais cobrem o ventre da Ship, o lado que enfrenta o fluxo de ar durante a reentrada. Elas ficam presas por pinos ao casco de aço e o protegem do calor da reentrada, de até cerca de 1.400 °C. O padrão hexagonal impede que o plasma quente passe em linha reta pelas juntas.', s: [['Placas', '~18.000'], ['Forma', 'Hexagonal'], ['Pico', '{tilePeak}']] },
...
SS_I18N.nl = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Hitteschild', t: 'Hitteschild', d: 'Zo\'n 18.000 zeshoekige keramische tegels bedekken de buikzijde van Ship, de kant die bij de terugkeer naar de luchtstroom is gericht. Ze zitten met pennen vast aan de stalen huid en beschermen die tegen de hitte van de terugkeer, tot ongeveer 1.400 °C. Het zeshoekige patroon voorkomt dat heet plasma recht door de naden stroomt.', s: [['Tegels', '~18.000'], ['Vorm', 'Zeshoekig'], ['Piek', '{tilePeak}']] },
...
SS_I18N.pl = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Osłona termiczna', t: 'Osłona termiczna', d: 'Około 18 000 sześciokątnych płytek ceramicznych pokrywa brzuch Ship, czyli stronę zwróconą ku strumieniowi powietrza podczas powrotu w atmosferę. Są przymocowane na kołkach do stalowego poszycia i chronią je przed żarem powrotu w atmosferę, sięgającym ok. 1400 °C. Sześciokątny wzór nie pozwala gorącej plazmie przepływać prosto przez szczeliny.', s: [['Płytki', '~18 000'], ['Kształt', 'Sześciokąt'], ['Szczyt', '{tilePeak}']] },
...
SS_I18N.ru = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Теплозащита', t: 'Теплозащитный экран', d: 'Около 18 000 шестиугольных керамических плиток покрывают «брюхо» корабля Старшип — сторону, обращённую к набегающему потоку при входе в атмосферу. Они закреплены на штифтах к стальной обшивке и защищают её от нагрева при входе в атмосферу — до примерно 1400 °C. Шестиугольный узор не даёт горячей плазме проходить по швам напрямую.', s: [['Плитки', '~18 000'], ['Форма', 'Шестиугольник'], ['Пик', '{tilePeak}']] },
...
SS_I18N.zh = {
  ...
  parts: {
    ...
    's-tiles': { n: '隔热罩', t: '隔热罩', d: '约 18,000 块六边形陶瓷隔热瓦覆盖星舰的腹部，也就是再入大气层时迎着气流的一面。它们用销钉固定在钢制外壳上，保护外壳免受高达约 1,400 °C 的再入高温。六边形排列可防止高温等离子体沿缝隙直线穿过。', s: [['隔热瓦', '~18,000'], ['形状', '六边形'], ['峰值', '{tilePeak}']] },
...
SS_I18N.tr = {
  ...
  parts: {
    ...
    's-tiles': { n: 'Isı kalkanı', t: 'Isı kalkanı', d: 'Yaklaşık 18.000 altıgen seramik karo, Ship\'in karın tarafını, yani atmosfere girişte hava akışına dönük yüzünü kaplar. Çelik kabuğa pimlerle tutturulurlar ve onu yaklaşık 1.400 °C\'ye varan atmosfere giriş ısısından korurlar. Altıgen desen, sıcak plazmanın derzlerden düz bir hatta geçmesini engeller.', s: [['Karo', '~18.000'], ['Şekil', 'Altıgen'], ['Tepe', '{tilePeak}']] },
...
SS_I18N.hi = {
  ...
  parts: {
    ...
    's-tiles': { n: 'हीट शील्ड', t: 'हीट शील्ड', d: 'लगभग 18,000 षट्कोणीय सिरेमिक टाइलें स्टारशिप के पेट वाले हिस्से को ढकती हैं, यानी वह सतह जो वायुमंडल में लौटते समय हवा के बहाव का सामना करती है। वे स्टील आवरण पर पिनों से लगी हैं और उसे लगभग 1,400 °C तक की वायुमंडल-प्रवेश गर्मी से बचाती हैं। षट्कोणीय पैटर्न गर्म प्लाज़्मा को जोड़ों से सीधे गुज़रने से रोकता है।', s: [['टाइलें', '~18,000'], ['आकार', 'षट्कोणीय'], ['अधिकतम', '{tilePeak}']] },
...
SS_I18N.ar = {
  ...
  parts: {
    ...
    's-tiles': { n: 'الدرع الحراري', t: 'الدرع الحراري', d: 'نحو 18,000 بلاطة خزفية سداسية تغطي بطن ستارشيب، أي الجانب الذي يواجه تيار الهواء أثناء العودة إلى الغلاف الجوي. تُثبَّت بمسامير على الغلاف الفولاذي وتحميه من حرارة العودة إلى الغلاف الجوي التي تصل إلى نحو 1,400 °م. يمنع النمط السداسي البلازما الساخنة من التدفق مباشرة عبر الفواصل.', s: [['البلاطات', '~18,000'], ['الشكل', 'سداسي'], ['الذروة', '{tilePeak}']] },
