...
SS_I18N.he = {
  ...
  parts: {
    ...
    'b-fwd': { n: 'כנפי גריד', t: 'כנפי גריד', d: 'ב-Block 3 יש שלוש כנפי גריד במקום ארבע. כל אחת גדולה בכ-50% ומותקנת נמוך יותר, בתושבת שמרותכת למכל המתאן, בתצורת T. זרועות המגדל ("הצ\'ופסטיקס") תופסות את הבוסטר ישירות בכנפיים האלה, כך שאין צורך בנקודות הרמה נפרדות.', s: [['כנפיים', '3'], ['גודל', '+50%'], ['השבה', 'תפיסה במגדל']] },
    'hsr': { n: 'מסבך ההפרדה', t: 'מסבך הפרדה חמה משולב', d: 'סטארשיפ מדליק את המנועים שלו כשהוא עדיין מחובר לבוסטר (הפרדה חמה). ב-Block 3 טבעת האוורור הנפרדת הישנה הוחלפה במסבך פתוח של מוטות בצורת V, שבנוי כחלק מהבוסטר. גזי הפליטה של סטארשיפ זורמים בין המוטות ופוגעים ישירות בכיפה העליונה של הבוסטר.', s: [['מבנה', 'מסבך V'], ['השלכה', 'לא נזרק'], ['מאז', 'טיסה 12']] },
...
SS_I18N.zh = {
  ...
  parts: {
    ...
    'hsr': { n: '热分离桁架', t: '一体式热分离桁架', d: '星舰在仍与助推器相连时就点燃发动机。Block 3 用内置于助推器的 V 形支杆开放式桁架，取代了以前单独的通风环。星舰 的尾焰从支杆之间流过，直接冲击助推器的顶部箱底。', s: [['结构', 'V 形桁架'], ['抛弃', '否'], ['始于', '第 12 次飞行']] },
    ...
    's-tanks': { n: '星舰贮箱', t: '星舰推进剂贮箱', d: '星舰在两个主贮箱中携带自己的液氧和甲烷；Block 3 把共底和下箱底移低，以容纳更多甲烷。甲烷经由穿过液氧贮箱的输送管到达发动机：三台海平面型发动机共用一根，每台 Raptor Vacuum 各有一根专用管。小型集液箱在主贮箱快空时仍能让着陆推进剂保持稳定。', s: [['主贮箱', '2'], ['输送管', '4'], ['集液箱', '2']] },
...
SS_I18N.hi = {
  ...
  parts: {
    ...
    'hsr': { n: 'हॉट-स्टेज ढाँचा', t: 'एकीकृत हॉट-स्टेजिंग ढाँचा', d: 'स्टारशिप बूस्टर से जुड़े रहते हुए ही अपने इंजन चालू कर देता है। Block 3 में पुरानी अलग हवादार रिंग की जगह बूस्टर में ही बना V-आकार के स्ट्रट्स का खुला ढाँचा है। स्टारशिप की निकास गैसें स्ट्रट्स के बीच से होकर सीधे बूस्टर के ऊपरी गुंबद से टकराती हैं।', s: [['डिज़ाइन', 'V ढाँचा'], ['अलग फेंकना', 'नहीं'], ['कब से', 'उड़ान 12']] },
